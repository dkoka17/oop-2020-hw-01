...
public class StringCodeTest extends TestCase {
	...
	public void testRun1() {
		...
		assertEquals(4, StringCode.maxRun("hooplllaaaa"));
	}
	...
	public void testIntersect1() {
		// basic cases
		assertEquals(true, StringCode.stringIntersect("abcd", "qwerabc", 3));
		assertEquals(false, StringCode.stringIntersect("abcd", "qwerac", 3));
